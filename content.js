...
(function () {
  ...
  var claims = {
    'denied': {
      ...
      intro: [
        ...
        'Maybe the carrier blamed wear and tear. Maybe it called the damage {{link:post:pre-existing-damage-denial-florida|pre-existing}}. Maybe it relied on an exclusion in the policy.',
    ...
    'delayed': {
      ...
      intro: [
        ...
        'When a claim appears to be stalled, we review what has happened, what the insurance company is still asking for, and whether there are steps available to get the claim moving again. Our post on {{link:post:why-is-my-florida-insurance-claim-taking-too-long|how long is too long}} covers the warning signs we look for.'
      ],
      sections: [
    ...
    'underpaid': {
      ...
      sections: [
        { heading: 'Where Underpayments Happen', type: 'named', body: [
          ...
          { term: 'Depreciation.', desc: 'Depreciation can significantly reduce an initial payment. We review how it was calculated, what items it was applied to, and whether additional amounts may become payable as repairs are completed. See {{link:post:recoverable-depreciation-florida-property-claim|our post on recoverable depreciation}} for more.' },
    ...
    'hurricane': {
      ...
      sections: [
        { heading: 'Common Issues in Hurricane and Tropical Storm Claims', type: 'named', body: [
          ...
          { term: 'Deductible issues.', desc: 'Hurricane and windstorm deductibles may differ from the deductible that applies to other types of losses. We review the policy and the insurance company\u2019s calculation to determine what deductible applies to the claim. Our post on {{link:post:how-hurricane-deductibles-work-florida|how hurricane deductibles work}} explains this in more detail.' },
    ...
    'roof': {
      ...
      sections: [
        { heading: 'Common Issues in Roof Damage Claims', type: 'named', body: [
          ...
          { term: 'Matching and material availability.', desc: 'Even when a repair is physically possible, questions may arise about whether compatible roofing materials are available and what the policy or applicable law requires when existing materials cannot reasonably be matched. See {{link:post:florida-roof-matching-law-shingles|our post on Florida’s roof matching law}} for more.' },
    ...
    'water': {
      ...
      intro: [
        ...
        'We review the physical evidence, plumbing findings, photographs, mitigation records, and policy language to determine whether the insurance company\u2019s position is supported by the facts. Our post on {{link:post:interior-water-damage-after-storm-florida|interior water damage after a storm}} covers a related scenario in more detail.'
      ],
      sections: [
    ...
    'el-nino': {
      ...
      metaTitle: 'El Ni\u00f1o Storm Damage Insurance Claims | Florida and Illinois Attorney - propertyinsurance.law',
      tagline: 'An El Ni\u00f1o season can send several damaging storms across the same property in a matter of months, and that is exactly when an insurance company starts calling the damage old, excluded, or already paid.',
      intro: [
        'El Ni\u00f1o is a recurring climate pattern, not a single storm. Surface water in the central and eastern tropical Pacific warms above its normal temperature, and that warming shifts the jet stream and changes weather across much of the United States for a season or longer.',
      ...
      sections: [
        { heading: 'The Damage an El Ni\u00f1o Season Causes', type: 'named', body: [
          { term: 'Severe storms and tornadoes.', desc: 'El Ni\u00f1o storm tracks have produced some of Florida\u2019s most destructive cool-season tornado outbreaks, along with damaging straight-line winds. Tornado and high-wind damage is rarely confined to what tore away first: roofing, soffit, fascia, siding, windows, and garage doors can fail in sequence, and the openings that result let rain into the building.' },
          { term: 'Flooding and heavy rain.', desc: 'El Ni\u00f1o winters tend to be wetter than normal. Repeated rainfall saturates the ground, overwhelms drainage, backs up gutters and scuppers, and pushes water into structures through roofs, windows, doors, and at grade. Coastal properties can also see persistent onshore winds, higher surf, and erosion over a period of weeks rather than a single day.' },
          { term: 'Roof and building envelope damage.', desc: 'Roof coverings, flashing, vents, skylights, seals, windows, and doors take the wear. This damage is frequently underestimated, because the interior water that shows up afterward gets treated as the loss instead of the opening that let it in.' },
          { term: 'Structural damage.', desc: 'Wind uplift and tornado-strength wind can move framing, trusses, connections, and walls without leaving damage that is obvious in photographs. Prolonged saturation can also affect soils, slabs, foundations, and retaining walls. Both usually call for a qualified evaluation rather than a visual inspection.' },
          { term: 'Detached structures and site damage.', desc: 'Fences, sheds, detached garages, screen enclosures, pool cages, docks, signage, landscaping, and debris removal are routinely left out of an estimate focused only on the main building.' },
          { term: 'Damage that accumulates across several storms.', desc: 'Repetition is the defining feature of an El Ni\u00f1o season. A roof that held through the first system may fail during the third, and by then the insurance company has several dates of loss available to point at instead of the one you reported.' }
        ]},
        { heading: 'Common Issues in El Ni\u00f1o Storm Claims', type: 'named', body: [
          { term: 'Wind versus flood.', desc: 'This is the central dispute in most El Ni\u00f1o claims. A standard property policy generally responds to wind damage and to rain that enters through a storm-created opening, while surface water and rising water are typically excluded and covered, if at all, under separate flood coverage. When wind and water reach a property in the same event, an insurance company may attribute the loss to the uncovered cause. Our post on {{link:post:wind-vs-flood-damage-florida-claim|wind versus flood damage}} explains how that line gets drawn and what evidence bears on it.' },
          { term: 'Pre-existing damage.', desc: 'After a season of repeated storms, \u201cthis was already here\u201d becomes an easy position for an insurance company to take. Whether it holds up is a factual and technical question. Prior inspection reports, real estate and maintenance records, dated photographs, permit history, roof age, and storm data for the reported date of loss can all be relevant. See our post on {{link:post:pre-existing-damage-denial-florida|pre-existing damage denials}} for how these denials are typically built.' },
          { term: 'Repair versus replacement.', desc: 'The insurance company may propose spot repairs to roofing, siding, framing, or interior finishes where a contractor or engineer concludes that more extensive work is necessary. Questions about whether compatible materials remain available, and what the policy or applicable law requires when they do not, come up often in storm claims. Our post on {{link:post:can-my-insurance-company-replace-only-half-my-roof-in-florida|replacing only part of a roof}} covers a common version of this dispute.' },
          { term: 'Notice and claim deadlines.', desc: 'Property policies and state law impose deadlines for reporting a loss, supplementing a claim, providing requested documents, demanding appraisal, and filing suit. In Florida, notice of a new or reopened property insurance claim generally must be given within one year of the date of loss, and a supplemental claim generally within 18 months. Deadlines can differ in Illinois and can depend on the policy. Our post on {{link:post:late-notice-denial-florida-insurance-claim|late notice denials}} explains what is at stake when reporting is delayed.' },
          { term: 'Which storm the damage came from.', desc: 'When several systems cross the same property in one season, the date of loss is not a formality. It can determine which policy year applies, which deductible applies, whether a windstorm or hurricane deductible is triggered, and when the reporting and suit deadlines began to run. An insurance company may also treat newly discovered damage as part of an earlier, already-closed claim.' }
        ]},
        { heading: 'How We Review an El Ni\u00f1o Storm Claim', type: 'para', body: [
      ...
      stepsHeading: 'What To Do After El Ni\u00f1o Storm Damage',
      steps: [
        '<strong style="color:var(--color-ink);font-weight:700">Report the damage promptly, and report it by storm.</strong> If more than one system hit your property, note what you observed after each one. Keep a record of when and how you reported the loss and what the insurance company told you.',
        '<strong style="color:var(--color-ink);font-weight:700">Document the property before cleanup when it is safe to do so.</strong> Take wide shots and close-ups of the roof, exterior, interior, ceilings, flooring, contents, fencing, detached structures, and debris. Date-stamped photographs and video are worth more than a description written later.',
        '<strong style="color:var(--color-ink);font-weight:700">Record how the water got in.</strong> In a wind-versus-flood dispute, photographs of openings in the roof or envelope, water lines on walls, and the height and direction of interior damage can be far more useful than photographs of standing water alone.',
        '<strong style="color:var(--color-ink);font-weight:700">Protect the property and keep the paperwork.</strong> Make reasonable temporary repairs, and keep tarping invoices, mitigation reports, moisture readings, receipts, and photographs of the work. Hold on to damaged materials where you can.',
        '<strong style="color:var(--color-ink);font-weight:700">Have the estimate reviewed before you accept it.</strong> If the insurance company\u2019s estimate limits the scope, blames a prior storm, or separates out the water damage, send us the estimate, the correspondence, and your photographs and reports. We can review the claim and identify where the scope or the coverage position may be incomplete.'
      ],
      faqs: [
        { q: 'Is there such a thing as El Ni\u00f1o coverage in my policy?', a: 'No. Property policies do not insure against a climate pattern; they respond to causes of loss such as windstorm, hail, lightning, or water damage, subject to the policy\u2019s terms, exclusions, and deductibles. El Ni\u00f1o matters because of the kinds of losses it produces, and because it tends to produce several of them in one season, not because it appears anywhere in the policy.' },
        { q: 'The insurance company says my damage was flooding, not wind. What can I do?', a: 'Wind versus flood is a factual question about how the damage occurred, and it is one of the most commonly disputed issues in storm claims. Photographs of storm-created openings, water lines and staining, the elevation and direction of the damage, mitigation and moisture records, engineering findings, and weather data for the date of loss can all bear on it. We review the basis for the insurance company\u2019s position and, when appropriate, work with qualified professionals to evaluate whether the evidence supports it.' },
        { q: 'Several storms hit my property this season. Do I file one claim or more than one?', a: 'It depends on the damage and the policy. Separate storms are generally separate losses, each with its own date of loss, deductible, and reporting deadline, and reporting them that way can matter. Where the damage overlaps or cannot be cleanly separated, the analysis becomes more complicated. Document what you observed after each event and have the situation reviewed rather than assuming the insurance company will sort it out correctly.' },
        { q: 'My insurance company says the damage was already there before the storm. How is that challenged?', a: 'Pre-existing damage denials are challenged with evidence. Prior inspection and appraisal reports, maintenance and permit records, dated photographs, roof age and condition before the loss, and storm data for the reported date can all be relevant. We review what the insurance company actually relied on and whether its conclusion holds up against the record of the property\u2019s condition before the storm.' },
        { q: 'How long do I have to report El Ni\u00f1o storm damage?', a: 'In Florida, notice of a new or reopened property insurance claim generally must be given within one year after the date of loss, and a supplemental claim generally within 18 months after the date of loss. Illinois deadlines differ, and your policy may impose its own requirements and shorter periods for taking particular steps. Because a claim can be spread across several storm dates in an El Ni\u00f1o season, it is worth having the timeline reviewed rather than assuming there is still time.' },
        { q: 'Do I need a lawyer for an El Ni\u00f1o storm damage claim?', a: 'A lawyer can materially help when the insurance company attributes the loss to flood or to a prior storm, limits the repair scope, applies a deductible you did not expect, or underpays the claim. An attorney can review the policy and claim documents, address the insurance company\u2019s coverage positions, coordinate supporting evidence, and pursue payment for damage that may have been overlooked or improperly excluded.' }
      ],
      ctaTitle: 'Storm damage the insurance company is calling old, excluded, or already paid?',
      ctaBody: 'Send us the insurance company\u2019s estimate, the denial or payment letter, your photographs, and any contractor or engineering reports. We\u2019ll review the claim and give you a straightforward assessment of where things stand.',
      related: [ { label: 'Hurricane & Tropical Storm', page: 'claim:hurricane' }, { label: 'Tornado', page: 'claim:tornado' }, { label: 'Water Damage', page: 'claim:water' } ]
    },
  ...
  var process = {
    'how-we-handle': {
      ...
      sections: [
        { heading: 'The Five Stages', type: 'named', body: [
          ...
          { term: '5. Litigation when it earns its keep.', desc: 'When suit is the path, we file prepared, because we prepared from stage three. You approve every major decision throughout, and settlement authority is always yours. Our post on {{link:post:how-long-florida-property-insurance-lawsuit|how long a property insurance lawsuit takes}} sets expectations for this stage.' }
        ]},
    ...
    'insurer-contractor': {
      ...
      intro: [
        ...
        'Sometimes it works fine. When it does not, homeowners discover the hard questions late: who warrants this work, who pays when the scope was short, and who answers when the repair fails after the file closes. Our post on {{link:post:do-i-have-to-use-insurance-preferred-contractor-florida|whether you have to use the insurer’s preferred contractor}} covers the ground rules.'
      ],
      sections: [
    ...
    'hurricane-readiness': {
      nav: 'Storm Resource Center', icon: 'triangle-alert',
      ...
      intro: [
        'After a major Florida storm, insurance companies can receive a large volume of claims in a short period of time. Inspections take longer, adjuster caseloads grow, and follow-up can stall. If your property is damaged, documenting the loss early and staying on top of the claim can make a meaningful difference.',
        'Our attorneys represent Florida property owners throughout the insurance claim process, from the initial claim through disputes over coverage, scope, and payment. If you have questions about what to document, what the insurance company is requesting, or whether your claim is being handled properly, we can review it with you.'
      ],
      urgentCtaTop: {
        heading: 'Already dealing with storm damage?',
        body: 'You do not need to wait for a denial before asking questions. Send us the carrier’s letter, estimate, photographs, or simply tell us what has happened so far. We will review the claim and tell you plainly where it stands.'
      },
      urgentCtaBottom: {
        heading: 'Did the storm damage your property?',
        body: 'If you have already reported the claim, send us what you have. If you have not reported it yet and are unsure where to start, we can walk you through the process.'
      },
      sections: [
        { heading: 'Track the Storm', type: 'para', body: [
          'This graphic from the National Hurricane Center shows the current tropical weather outlook for the Atlantic basin and updates automatically as conditions change.',
          ...
          '<span style="display:block;font-family:var(--font-sans);font-size:13px;color:var(--color-muted);margin-top:8px">Source: NOAA / National Hurricane Center. This graphic is hosted directly by NOAA and reflects its most recent update. For current advisories, forecast cones, and additional storm information, visit the <a href="https://www.nhc.noaa.gov/?atlc" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">National Hurricane Center’s Atlantic page</a>.</span>'
        ]},
        { heading: 'Official Emergency Resources', type: 'named', body: [
          ...
          { term: 'Ready.gov Hurricane Guide.', desc: 'FEMA preparation information and family emergency planning resources. <a href="https://www.ready.gov/hurricanes" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">ready.gov/hurricanes</a>' },
        ...
        { heading: 'More Preparedness Resources', type: 'named', body: [
          { term: 'NWS: Hurricane Safety Overview.', desc: 'The National Weather Service’s hurricane safety guidance. <a href="https://www.weather.gov/safety/hurricane" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane</a>' },
          { term: 'NWS: Understanding Watches & Warnings.', desc: 'What hurricane watches, warnings, and storm surge warnings mean. <a href="https://www.weather.gov/safety/hurricane-ww" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-ww</a>' },
          { term: 'NWS: Make an Emergency Plan.', desc: 'Guidance for building a family communication and evacuation plan before a storm. <a href="https://www.weather.gov/safety/hurricane-plan" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-plan</a>' },
          { term: 'NWS: What to Do During the Storm.', desc: 'Safety guidance for the hours when a storm is affecting your area. <a href="https://www.weather.gov/safety/hurricane-action" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-action</a>' },
          { term: 'NWS: What to Do After the Storm.', desc: 'Official post-storm safety guidance, including hazards to watch for after a storm passes. <a href="https://www.weather.gov/safety/hurricane-after" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-after</a>' },
          { term: 'NHC: Hurricane Hazards Explained.', desc: 'Information about storm surge, wind, inland flooding, tornadoes, and other hurricane hazards. <a href="https://www.nhc.noaa.gov/prepare/hazards.php" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">nhc.noaa.gov/prepare/hazards.php</a>' },
          { term: 'NOAA: Historical Hurricane Tracks.', desc: 'An interactive map showing historical storm tracks near your area. <a href="https://coast.noaa.gov/hurricanes/#map=4/32/-80" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">coast.noaa.gov/hurricanes</a>' },
          { term: 'Evacuate or Shelter in Place?', desc: 'Guidance from DisasterAssistance.gov for determining whether to evacuate or remain in place. <a href="https://www.disasterassistance.gov/information/immediate-needs/evacuate-or-stay-put" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">disasterassistance.gov</a>' },
          { term: 'American Red Cross: Make a Plan.', desc: 'A family emergency planning resource from the American Red Cross. <a href="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/make-a-plan.html" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">redcross.org</a>' },
          { term: 'American Red Cross: Pet Disaster Preparedness.', desc: 'Evacuation and shelter planning for households with pets. <a href="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/pet-disaster-preparedness.html" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">redcross.org</a>' },
          { term: 'Helping Children Cope After a Disaster.', desc: 'Guidance from the National Child Traumatic Stress Network for helping children after a disaster. <a href="https://www.nctsn.org/what-is-child-trauma/trauma-types/disasters" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">nctsn.org</a>' },
          { term: 'Special-Needs Evacuation Planning.', desc: 'Accessible evacuation and registration guidance from the Disability Achievement Center for Pinellas and Pasco County residents with disabilities. <a href="https://www.mydacil.org/disaster-services" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">mydacil.org</a>' }
        ]},
        { heading: 'What to Do Immediately After the Storm', type: 'para', body: [
          'Once it is safe to do so, check for immediate hazards such as downed power lines, gas leaks, standing water near electrical sources, or structural damage before entering the property.',
          'Take reasonable steps to prevent additional damage if you can do so safely. Depending on the circumstances, this may include temporary roof protection, water extraction, or other emergency measures. Photograph the condition of the property and keep contracts, invoices, and receipts for any work performed.',
          'Photograph and video the damage before cleanup or permanent repairs begin whenever possible. Report the claim to your insurer promptly. Florida law generally requires notice of a new or reopened property insurance claim within one year after the date of loss and notice of a supplemental claim within 18 months.',
          'Be cautious with contractors who arrive in the neighborhood immediately after a storm. Verify licenses where applicable, get the scope and price of the work in writing, and read anything you are asked to sign before signing it.'
        ]}
      ],
      stepsHeading: 'Before Landfall: A Short Checklist',
      steps: [
        '<strong style="color:var(--color-ink);font-weight:700">Document the property before the storm.</strong> Take photographs or video of the rooms inside your home, the roof and exterior where safely accessible, outdoor structures, and significant personal property.',
        '<strong style="color:var(--color-ink);font-weight:700">Locate your complete insurance policy.</strong> Keep a copy somewhere you can access if your home loses power, internet service, or becomes inaccessible.',
        '<strong style="color:var(--color-ink);font-weight:700">Check your hurricane deductible.</strong> Review your declarations page so you know the deductible that may apply and your dwelling coverage limit.',
        '<strong style="color:var(--color-ink);font-weight:700">Protect the property if it is safe to do so.</strong> Secure loose outdoor items and install shutters or other approved protection if you have them and conditions allow.',
        '<strong style="color:var(--color-ink);font-weight:700">Save important contact information.</strong> Keep your insurer’s claim-reporting information, emergency contacts, and this page somewhere you can access after the storm.'
      ],
      faqs: [
        { q: 'How long do I have to file a hurricane damage claim in Florida?', a: '<p style="margin:0 0 12px">Florida law generally requires notice of a new or reopened property insurance claim within one year after the date of loss. A supplemental claim generally must be reported within 18 months after the date of loss.</p><p style="margin:0">Waiting can create additional problems even when the statutory deadline has not expired. Report known damage as soon as reasonably possible and keep records of when and how you reported it.</p>' },
        { q: 'Can I supplement my claim if additional damage or repair costs are discovered later?', a: '<p style="margin:0">Potentially, yes. Florida law recognizes supplemental property insurance claims, but they are subject to an 18-month notice deadline and the terms and conditions of the policy. Keep documentation of additional damage and repair costs as they become known.</p>' },
        { q: 'How does my hurricane deductible work?', a: '<p style="margin:0 0 12px">Florida personal-lines residential policies commonly have a separate hurricane deductible. Depending on the policy, it may be stated as a percentage of the dwelling limit or another permitted amount.</p><p style="margin:0">For personal-lines residential policies subject to Florida’s hurricane-deductible statute, the hurricane deductible generally applies on an annual basis to covered hurricane losses occurring during the same calendar year. Your declarations page and policy will identify the deductible that applies to your property.</p>' },
        { q: 'What if I cannot stay in my home after the storm?', a: '<p style="margin:0 0 12px">Many homeowners policies provide additional living expense coverage when a covered loss makes the home uninhabitable. Depending on the policy, this may include certain temporary housing and related additional expenses.</p><p style="margin:0">Keep receipts and records of what you spend. Coverage and applicable limits depend on your policy and the circumstances of the loss.</p>' },
        { q: 'Do I have to use the insurance company’s preferred contractor?', a: '<p style="margin:0 0 12px">Not necessarily. Many policyholders can select their own contractor, but some policies contain managed-repair, preferred-contractor, or election-to-repair provisions that can affect how repairs are handled.</p><p style="margin:0">Before agreeing to a repair program or signing a contract, review the applicable policy language and the documents the insurer has provided.</p>' },
        { q: 'My insurer says the roof damage is wear and tear, not storm damage. What now?', a: '<p style="margin:0 0 12px">Disputes over whether roof damage resulted from a storm, age, deterioration, installation issues, or another cause are common after hurricanes and severe weather.</p><p style="margin:0">Photographs, inspection findings, repair history, weather information, and other evidence can be important in evaluating the carrier’s conclusion. We can review the denial or coverage letter and the evidence supporting the claim to determine what the carrier relied on and what may have been overlooked.</p>' },
        { q: 'Is flood damage covered under my homeowners policy?', a: '<p style="margin:0 0 12px">Standard homeowners policies generally exclude flooding caused by rising surface water. Flood coverage is commonly purchased separately through the National Flood Insurance Program or a private flood insurer.</p><p style="margin:0">Wind damage may be covered under a homeowners policy. Coverage for rain or other water entering the property depends on the policy language, the cause of the opening or intrusion, and the facts of the loss.</p>' },
        { q: 'What happens if my insurance company becomes insolvent after a major storm?', a: '<p style="margin:0 0 12px">If a Florida property insurer is placed into liquidation, the Florida Insurance Guaranty Association may become responsible for certain eligible covered claims, subject to statutory requirements, exclusions, limits, and deadlines.</p><p style="margin:0">An insolvency can also affect the status of the existing insurance policy. Policyholders should pay close attention to notices concerning cancellation dates and replacement coverage.</p>' },
        { q: 'When should I contact an attorney about my hurricane claim?', a: '<p style="margin:0 0 12px">You do not have to wait until the insurance company denies the claim.</p><p style="margin:0">We review claims at different stages of the process, including before an inspection, while the carrier is investigating, after a request for additional information, and after a claim has been denied, delayed, or underpaid. An early review can help identify what the policy requires, what documentation may still be needed, and whether there are problems with the way the claim is being handled.</p>' }
      ],
      ctaTitle: 'Storm damage? Send us what you have.',
      ctaBody: 'The carrier’s letter, an estimate, photographs, or just the story so far. A <strong style="color:#fff">propertyinsurance.law</strong> attorney will review your claim for free and tell you plainly where it stands.',
      disclaimer: 'This page is provided for general informational purposes and is not legal advice. Storm tracking information is provided by NOAA and may change rapidly. Always follow current instructions from local authorities, emergency management officials, and the National Weather Service. Insurance coverage depends on the specific policy language and facts of each loss.',
  ...
  var faq = {
    ...
    groups: [
      { title: 'Denied, Delayed, and Underpaid Claims', items: [
        { q: 'What should I do if my homeowners insurance claim is denied?', a: '<p style="margin:0 0 12px">Start with the denial letter. It should explain why the insurance company denied the claim and identify the policy provisions it relied on. A denial does not automatically mean the claim is over.</p><p style="margin:0">We review the policy, the stated reason for the denial, and the evidence behind it to determine whether the insurance company\u2019s position can be challenged. If you received a denial letter, send it to us. An attorney can review it with you at no charge and explain what options may still be available. See our post on {{link:post:insurance-company-denied-my-roof-claim-in-florida-now-what|what to do after a denial}} for a closer look.</p>' },
    ...
    posts: [
      {
        ...
        body: [
          ...
          { type: 'para', text: 'The answer depends largely on how the water entered the property and what your policy says.' },
                    { type: 'para', text: 'For more on how these disputes are typically handled, see our overview of {{link:claim:water|water damage insurance claims}} in Florida.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how insurance companies evaluate storm damage to roofs can help you better prepare for the inspection and identify potential areas of dispute.' },
                    { type: 'para', text: 'If your roof claim was affected by this kind of evaluation, our page on {{link:claim:roof|roof damage insurance claims}} explains the issues that come up most often.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how this coverage works can make a substantial difference in the amount paid on your claim.' },
                    { type: 'para', text: 'Code related disputes like this come up often in {{link:claim:hurricane|hurricane and tropical storm damage claims}}, where older roofs and building systems must be brought up to current code.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how insurers analyze subsequent losses can help you approach the situation properly.' },
                    { type: 'para', text: 'If this sounds familiar, our overview of {{link:claim:roof|roof damage insurance claims}} covers how these disputes are typically resolved.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how wind versus flood damage is evaluated can help you navigate this common dispute.' },
                    { type: 'para', text: 'This distinction comes up constantly in {{link:claim:hurricane|hurricane and tropical storm damage claims}}, where wind and flood damage often occur together.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how hurricane deductibles work in Florida is critical before you file a claim and especially after you receive a payment estimate.' },
                    { type: 'para', text: 'For a broader look at how these claims are handled, see our page on {{link:claim:hurricane|hurricane and tropical storm damage claims}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'If your hurricane claim was denied, you are likely asking why. Understanding the most common reasons Florida hurricane claims get denied can help you evaluate whether the insurer’s position may be justified or worth closer review.' },
                    { type: 'para', text: 'We handle these disputes regularly as part of our {{link:claim:hurricane|hurricane and tropical storm damage claims}} practice.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Knowing what to do immediately after hurricane damage can help protect your property, preserve evidence, and avoid common claim mistakes.' },
                    { type: 'para', text: 'Our {{link:claim:hurricane|hurricane and tropical storm damage claims}} page walks through what typically happens next if the claim is denied, delayed, or underpaid.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'The short answer is that Florida regulations require repairs to result in a reasonably uniform appearance. However, whether that means full roof replacement depends on the specific facts of the claim.' },
                    { type: 'para', text: 'Matching disputes are one of the most common issues we see in {{link:claim:roof|roof damage insurance claims}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding what insurers mean by pre-existing damage and how these disputes are evaluated can help you determine your next step.' },
                    { type: 'para', text: 'If your claim was denied on this basis, our page on {{link:claim:denied|denied insurance claims}} explains how we evaluate these disputes.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how late notice works under Florida property insurance policies can help you evaluate whether the denial is justified.' },
                    { type: 'para', text: 'Late notice is one of several issues we address on our {{link:claim:denied|denied insurance claims}} page.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Homeowners across Florida are often surprised by how much is deducted for roof depreciation. Understanding how Florida insurance companies calculate roof depreciation can help you determine whether the payment you received is consistent with your policy.' },
                    { type: 'para', text: 'Depreciation disputes are common in {{link:claim:roof|roof damage insurance claims}}, particularly when the roof is older.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'The answer depends on who performed the repairs, what caused the failure, and what your policy says.' },
                    { type: 'para', text: 'Our page on {{link:process:insurer-contractor|managed repair and the insurer’s contractor}} explains your rights when repairs are handled through the insurance company’s own network.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'In most situations, the answer is no. As a homeowner, you generally have the right to choose your own contractor. However, there are important details to understand before making a decision.' },
                    { type: 'para', text: 'We cover this in more detail on our {{link:process:insurer-contractor|managed repair and the insurer’s contractor}} page.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding why estimates differ and how to approach the gap can help you determine your next step.' },
                    { type: 'para', text: 'This kind of gap is one of the clearest signs of an {{link:claim:underpaid|underpaid insurance claim}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding when reopening may be appropriate and how to approach the process can help you avoid unnecessary complications.' },
                    { type: 'para', text: 'If your claim was closed too early, our page on {{link:claim:underpaid|underpaid insurance claims}} explains how we approach reopening it.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how depreciation works is critical to knowing whether you have received the full amount owed under your policy.' },
                    { type: 'para', text: 'Recoverable depreciation disputes are one of the more common issues we see on {{link:claim:underpaid|underpaid insurance claims}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding when an attorney may be helpful and when it may not be necessary can help you make an informed decision.' },
                    { type: 'para', text: 'If your claim has already been denied, our {{link:claim:denied|denied insurance claims}} page explains what we look for when deciding whether to get involved.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'The honest answer is that it depends. Every case is different. However, understanding the general timeline and the factors that influence it can help you set realistic expectations.' },
                    { type: 'para', text: 'Our {{link:process:how-we-handle|how we handle your claim}} page walks through what to expect if a lawsuit becomes necessary.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding the difference between cancellation and nonrenewal, and knowing what protections apply, can help you evaluate your situation calmly and clearly.' },
                    { type: 'para', text: 'If you are unsure where your claim stands after a cancellation notice, our {{link:process:how-we-handle|how we handle your claim}} page explains what to expect when you reach out.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding what an EUO is and how it works can help you approach the situation carefully and confidently.' },
                    { type: 'para', text: 'An EUO often signals the insurer is building toward a denial, an issue we address on our {{link:claim:denied|denied insurance claims}} page.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding what it is and how it may affect your claim can help you make an informed decision.' },
                    { type: 'para', text: 'These statements are often used to support a later denial, which is why we cover them on our {{link:claim:denied|denied insurance claims}} page.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding why underpayments happen and how to respond can help you protect your rights.' },
                    { type: 'para', text: 'For more on how we evaluate these disputes, see our {{link:claim:underpaid|underpaid insurance claims}} page.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how insurers calculate roof claim payments can help you determine whether your payout appears accurate or potentially underpaid.' },
                    { type: 'para', text: 'We break down these numbers regularly as part of our {{link:claim:roof|roof damage insurance claims}} practice.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding this exclusion and how it is applied can help you determine whether the denial reflects legitimate policy language or a disputed interpretation of the damage.' },
                    { type: 'para', text: 'If your roof claim was denied on this basis, our {{link:claim:denied|denied insurance claims}} page explains how we evaluate the carrier’s position.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding how roof matching works in Florida can help you determine whether a partial replacement is appropriate or whether the carrier’s scope may be insufficient.' },
                    { type: 'para', text: 'Partial roof replacement disputes are one of the more common issues we see in {{link:claim:roof|roof damage insurance claims}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'If you are unsure whether your denial was handled properly, you may benefit from having the denial letter and policy reviewed by a Florida property insurance attorney. An early review can help clarify whether the carrier’s position is supported by the policy language.' },
                    { type: 'para', text: 'Our {{link:claim:denied|denied insurance claims}} page walks through the options available once a denial like this arrives.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Understanding the difference between a normal delay and a problematic one can help you decide what to do next.' },
                    { type: 'para', text: 'If this sounds like your situation, our {{link:claim:delayed|delayed insurance claims}} page explains what we look at when a claim has stalled.' },
      ...
      },
      {
        ...
        body: [
          { type: 'para', text: 'With hurricane season threatening homes across Florida every year, flood damage is one of the most devastating and expensive losses a homeowner can face. At <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, we represent Florida policyholders when their flood insurance claims are denied, delayed, or underpaid. This guide breaks down the key facts every Florida homeowner needs to know about flood insurance, claims, and policyholder rights.' },
                    { type: 'para', text: 'For more on how Florida policies handle these losses, see our page on {{link:claim:water|water damage insurance claims}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'Below are the top five insurance questions we receive from homeowners and how Florida law applies to each one.' },
                    { type: 'para', text: 'For a deeper look at one of the most common issues homeowners raise, see our page on {{link:claim:delayed|delayed insurance claims}}.' },
      ...
      },
      {
        ...
        body: [
          ...
          { type: 'para', text: 'At <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, we help Florida homeowners navigate the fine print of their insurance policies to ensure they recover everything they’re owed after a loss. Here’s what you need to know about the two main types of homeowners insurance policies.' },
                    { type: 'para', text: 'Understanding this distinction is often the first step in identifying an {{link:claim:underpaid|underpaid insurance claim}}.' },
  ...
  var policies = {
    ...
    sections: [
      ...
      { id: 'privacy-policy', toc: 'Privacy policy', heading: 'Privacy Policy', body: [
        'At <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, we respect your privacy and are committed to protecting your personal information. This Privacy Policy explains how we collect, use, and safeguard information when you visit our website or communicate with our firm, including by phone, email, or text message.',
        '<b>1. Information We Collect.</b> We may collect personal information you voluntarily provide, such as your name, email address, phone number, or other details you share when completing a contact form, subscribing to updates, or communicating with our office. We may also collect limited technical data such as your IP address, browser type, and device information to help us improve website performance and security.',
        '<b>2. How We Use Your Information.</b> We use your information to respond to inquiries and provide requested legal services; communicate regarding ongoing or potential representation; send updates, notices, and service-related messages (including by text); and maintain client records and comply with professional or legal obligations. We do not sell or rent your personal information to third parties.',
        '<b>3. Text Messaging and Communication Consent.</b> By providing your phone number, you consent to receive text messages from <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b> related to your inquiry, claim, or representation. Message frequency may vary. Standard message and data rates may apply. You may opt out of text messages at any time by replying STOP to any message.',
        '<b>4. Data Security.</b> We maintain administrative, technical, and physical safeguards to help protect your information from unauthorized access, loss, or disclosure. However, no system is completely secure, and we cannot guarantee absolute protection of data transmitted over the Internet.',
        '<b>5. Sharing of Information.</b> We may share limited information with trusted service providers who assist us in operating our website or managing communications, including our third-party text messaging provider (Twilio). These partners are required to maintain confidentiality and use your information only as needed to perform their contracted services.',
        '<b>6. Confidentiality of Legal Communications.</b> Communications sent through this website or by text message do not automatically create an attorney–client relationship. Please avoid including confidential or time-sensitive information unless and until a formal engagement agreement has been executed.',
        '<b>7. Your Rights and Choices.</b> You may request access to, correction of, or deletion of your personal information by contacting us at <a href="mailto:info@propertyinsurance.law" style="color:var(--color-primary);font-weight:600;text-decoration:none">info@propertyinsurance.law</a>. You may also opt out of marketing or informational communications at any time.',
        '<b>8. Updates to This Policy.</b> We may update this Privacy Policy periodically to reflect changes in our practices or applicable law. The most current version will always appear on this page with the updated effective date.',
        '<b>9. Contact Us.</b> If you have any questions about this Privacy Policy or our data practices, please contact us: <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, Attn: Privacy Compliance, 941 W. Morse Blvd. Ste 100-585, Winter Park, FL 32789. Email <a href="mailto:info@propertyinsurance.law" style="color:var(--color-primary);font-weight:600;text-decoration:none">info@propertyinsurance.law</a> or call <a href="tel:14075028068" style="color:var(--color-primary);font-weight:600;text-decoration:none">(407) 502-8068</a>.'
      ]},
      { id: 'terms-of-use', toc: 'Terms of use', heading: 'Terms of Use', body: [
        'Welcome to <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>. By accessing or using this website, you agree to the following Terms of Use. Please read them carefully. If you do not agree, please do not use this website.',
        '<b>1. Purpose of This Website.</b> This website provides general information about <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, our attorneys, and our legal services. The materials are for informational purposes only and are not legal advice. You should not act or refrain from acting based on any information on this site without seeking professional counsel.',
        '<b>2. No Attorney–Client Relationship.</b> Your use of this website, including sending an inquiry or contacting us via form, email, or text message, does not create an attorney–client relationship. Such a relationship is only established after a written engagement agreement is executed by both parties.',
        '<b>3. Use of This Website.</b> You agree to use this site only for lawful purposes and in compliance with all applicable laws. You may not use this website to transmit unlawful, defamatory, fraudulent, or harmful content; interfere with the site’s functionality or security; or engage in spam, phishing, or other abusive practices.',
        '<b>4. Intellectual Property.</b> All content on this website, including text, graphics, logos, and design, is owned or licensed by <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b> and protected by copyright and other intellectual property laws. You may view and print pages for personal, noncommercial use only. Reproduction, modification, or redistribution without prior written consent is prohibited.',
        '<b>5. Text Messaging and Communication Consent.</b> By submitting your phone number or contact information, you consent to receive communications from <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, including text messages related to your inquiry, claim, or representation. Message frequency may vary. Message and data rates may apply. You may opt out by replying STOP.',
        '<b>6. Third-Party Links.</b> This website may contain links to external websites operated by third parties. These links are provided for convenience only. We are not responsible for and do not endorse the content, accuracy, or privacy practices of those sites.',
        '<b>7. Disclaimers and Limitation of Liability.</b> We strive to ensure that information on this website is accurate and current, but we make no representations or warranties of any kind. Use of this website is at your own risk. To the fullest extent permitted by law, <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b> disclaims all liability for damages resulting from your use of, or inability to use, this site.',
        '<b>8. Governing Law.</b> These Terms are governed by and construed in accordance with the laws of the State of Florida, without regard to conflict-of-law principles. Any disputes shall be resolved in the state or federal courts located in Orange County, Florida.',
        '<b>9. Modifications.</b> We may update or modify these Terms at any time. Continued use of this site after changes are posted constitutes acceptance of the updated Terms.',
        '<b>10. Contact Us.</b> For questions or concerns regarding these Terms, please contact us: <b>propertyinsurance<span style="color:var(--color-primary)">.law</span></b>, Attn: Website Administration, 941 W. Morse Blvd. Ste 100-585, Winter Park, FL 32789. Email <a href="mailto:info@propertyinsurance.law" style="color:var(--color-primary);font-weight:600;text-decoration:none">info@propertyinsurance.law</a> or call <a href="tel:14075028068" style="color:var(--color-primary);font-weight:600;text-decoration:none">(407) 502-8068</a>.'
      ]},
