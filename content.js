    ...
    'hurricane-readiness': {
      ...
      sections: [
        ...
        { heading: 'More Preparedness Resources', type: 'named', body: [
          { term: 'NWS: Hurricane Safety Overview.', desc: 'The National Weather Service’s hub for hurricane safety guidance. <a href="https://www.weather.gov/safety/hurricane" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane</a>' },
          { term: 'NWS: Understanding Watches & Warnings.', desc: 'What a hurricane watch, warning, or storm surge warning actually means and how much time it gives you. <a href="https://www.weather.gov/safety/hurricane-ww" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-ww</a>' },
          { term: 'NWS: Make an Emergency Plan.', desc: 'Building a family communication and evacuation plan before a storm forms. <a href="https://www.weather.gov/safety/hurricane-plan" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-plan</a>' },
          { term: 'NWS: What to Do During the Storm.', desc: 'Safety guidance for the hours the storm is actually overhead. <a href="https://www.weather.gov/safety/hurricane-action" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-action</a>' },
          { term: 'NWS: What to Do After the Storm.', desc: 'Official post-storm safety guidance, including hazards to watch for once it passes. <a href="https://www.weather.gov/safety/hurricane-after" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">weather.gov/safety/hurricane-after</a>' },
          { term: 'NHC: Hurricane Hazards Explained.', desc: 'How storm surge, wind, inland flooding, and tornadoes each pose different risks in a hurricane. <a href="https://www.nhc.noaa.gov/prepare/hazards.php" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">nhc.noaa.gov/prepare/hazards.php</a>' },
          { term: 'NOAA: Historical Hurricane Tracks.', desc: 'An interactive map of past storm tracks near your area, useful for understanding local risk. <a href="https://coast.noaa.gov/hurricanes/#map=4/32/-80" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">coast.noaa.gov/hurricanes</a>' },
          { term: 'Evacuate or Shelter in Place?', desc: 'A decision guide from DisasterAssistance.gov for weighing evacuation against staying put. <a href="https://www.disasterassistance.gov/information/immediate-needs/evacuate-or-stay-put" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">disasterassistance.gov</a>' },
          { term: 'American Red Cross: Make a Plan.', desc: 'A step-by-step family emergency plan template. <a href="https://www.redcross.org/get-help/how-to-prepare-for-emergencies/make-a-plan.html" target="_blank" rel="noopener" style="color:var(--color-primary);font-weight:600;text-decoration:underline;text-underline-offset:3px">redcross.org</a>' },
